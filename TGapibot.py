...
• {self.t(user_id, "help_feature_1")}
• {self.t(user_id, "help_feature_2")}
• {self.t(user_id, "help_feature_3")}
...
• {self.t(user_id, "help_proxy_auto_read")}
• {self.t(user_id, "help_proxy_support")}
        """
...
<b>⚡ {self.t(user_id, "convert_features_title")}</b>
• {self.t(user_id, "convert_batch_concurrent")}
• {self.t(user_id, "convert_realtime_progress")}

<b>📤 {self.t(user_id, "convert_instructions")}</b>
{select_prompt}
        """
